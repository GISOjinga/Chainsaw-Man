...
local GJK = require(script.Parent:WaitForChild("GJK"))
local Supports = require(script.Parent:WaitForChild("Supports"))
local Vertices = require(script.Parent:WaitForChild("Vertices"))
...
function RotatedRegion3.new(cframe, size)
	...
	self.Centroid = cframe.Position
	
    local oof1,oof2 = worldBoundingBox(self.Set)
	self.AlignedRegion3 = Region3.new(oof1, oof2)
...
function RotatedRegion3.Cylinder(cframe, size)
    ...
    local oof1,oof2 = worldBoundingBox(getCorners(unpack(self.Set)))
	self.AlignedRegion3 = Region3.new(oof1, oof2)
	return self
end
...
function RotatedRegion3:FindPartsInRegion3(ignore, maxParts)
	local found = {}
	local CF = self.AlignedRegion3.CFrame
	local Size = self.AlignedRegion3.Size
